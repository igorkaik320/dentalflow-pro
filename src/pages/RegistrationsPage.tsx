...
import {
  ...
  Clock, DollarSign, Stethoscope, Building, Tag, Calendar,
} from "lucide-react";
...
function mapSupplier(row: any): Supplier {
  return {
    ...
    cnpj: formatDocument(row.document || row.cnpj || ""),
    document: formatDocument(row.document || row.cnpj || ""),
    phone: row.phone || "",
    mobile: row.mobile || "",
    email: row.email || "",
...
export default function RegistrationsPage() {
  ...
  const saveSupplier = async () => {
    ...
    const payload = {
      ...
      legal_name: supplierForm.legalName || null,
      cnpj: supplierForm.document || supplierForm.cnpj,
      document: supplierForm.document || supplierForm.cnpj,
